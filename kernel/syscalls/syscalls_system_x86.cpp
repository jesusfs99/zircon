...
// TODO(teisenbe): Remove this, see use below
extern "C" void platform_init_debug_early(void);
...
zx_status_t suspend_thread(void* raw_arg) {
    ...
    // TODO(teisenbe): Remove this once we integrate platform devices into pc
